...
<div style="margin: 20px 0; text-align: center;">
  <a href="https://github.com/josephineoe/Multi-robot-Workstation-ABB_RobotStudio" style="display: inline-block; padding: 10px 20px; background-color: #333; color: #fff; text-decoration: none; border-radius: 5px; font-weight: 500; transition: background-color 0.3s;">
