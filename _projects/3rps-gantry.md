---
layout: project
title: "Gait Rehabilitation Device"
...
github_url: "https://github.com/josephineoe/-3RPS-Gantry-System-for-Motor-Rehabilitation"
  ...
  - name: "IMU Sensor Implementation"
    ...
    content: |
      ...
      void mpu6050_read(imu_data_t *data) {
          ...
          data->accel[0] = (buf[0] << 8) | buf[1];
          data->accel[1] = (buf[2] << 8) | buf[3];
          data->accel[2] = (buf[4] << 8) | buf[5];
          data->temp     = (buf[6] << 8) | buf[7];
          data->gyro[0]  = (buf[8] << 8) | buf[9];
          data->gyro[1]  = (buf[10] << 8) | buf[11];
          data->gyro[2]  = (buf[12] << 8) | buf[13];
      }
...
gallery:
  ...
  - type: "video"
    ...
    description: "Troubleshootinng (dev stage)"
---
...
<div style="margin: 20px 0; text-align: center;">
  <a href="https://github.com/josephineoe/-3RPS-Gantry-System-for-Motor-Rehabilitation" style="display: inline-block; padding: 10px 20px; background-color: #333; color: #fff; text-decoration: none; border-radius: 5px; font-weight: 500; transition: background-color 0.3s;">
